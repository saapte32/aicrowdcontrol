...
def index(request):
    return render(request, 'detect/dashboard28jul.html')
...
def handler404(request,exception):
    return render(request, 'detect/404.html', status=404)
...
def violations(request):
    ...
    # import pdb;pdb.set_trace()
    return render(request, 'detect/dashboard28jul.html', {"violations": violationrecords,
...
def clicksd(request, fordate='1', cameraid=2):
    #import pdb;pdb.set_trace()
    print("sd clicked 2 para_________----------------------------", fordate, cameraid)
    path_details = {"vidurl": "/static/assets/SD_distancing202007271625.mp4"}
    if request.session.get('cameraID')=='2':
        # print("cam1")
        #path_details = {"vidurl": "/static/assets/SD_distancing202007271705.mp4"}
        path_details = {"vidurl": "/static/assets/SD_distancing202007271625.mp4"}
    else:
        #print("cam2")
        path_details = {"vidurl": "/static/assets/SD_distancing202007271625.mp4"}
...
def clickmask(request, fordate='1', cameraid=2):
    print("mask clicked 2 para%%%%%%%%%%%%%%%%%%%%$$$$$$$$$$$$", fordate, cameraid)
    path_details = {"vidurl": "/static/assets/FM202007271625.mp4"}
    #import pdb;pdb.set_trace()
    if request.session.get('cameraID') == '2':
        # print("cam1")
        #path_details = {"vidurl": "/static/assets/FM202007271705.mp4"}
        path_details = {"vidurl": "/static/assets/FM202007271625.mp4"}
    else:
        #print("cam2")
        path_details = {"vidurl": "/static/assets/FM202007271625.mp4"}
